...
import { ImageLinkListElement } from "../components/commonComponents.jsx";

export const animationLinkInfo = {
    imgSource: inkbleed_still,
    altText: "A drawing of a small bird.",
    link: "/animation",
}

export const postersLinkInfo = {
